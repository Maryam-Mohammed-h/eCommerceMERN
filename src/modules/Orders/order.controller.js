...
export const successPayment = async (req, res, next) => {
  ...
  // res.send({ message: "success",redirect_path: "Get back to the website : http://localhost:3000"});

  // return res.redirect(`http://localhost:3000/order`)
  res.send('<script>window.location.href="https://marygshop.netlify.app/#/order";</script>');
  // res.writeHead(301, {
